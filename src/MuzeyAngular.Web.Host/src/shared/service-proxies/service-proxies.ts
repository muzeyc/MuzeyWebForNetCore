...
@Injectable()
export class MuzeyServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    /**
     * @param reqModel (optional) 
     * @return Success
     */
    req(reqModel: MuzeyReqModelOfObject | null | undefined): Observable<MuzeyResModelOfObject> {
        let url_ = this.baseUrl + "/api/services/app/Muzey/Req";
        url_ = url_.replace(/[?&]$/, "");

        const content_ = JSON.stringify(reqModel);
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processReq(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processReq(<any>response_);
                } catch (e) {
                    return <Observable<MuzeyResModelOfObject>><any>_observableThrow(e);
                }
            } else
                return <Observable<MuzeyResModelOfObject>><any>_observableThrow(response_);
        }));
    }

    protected processReq(response: HttpResponseBase): Observable<MuzeyResModelOfObject> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? MuzeyResModelOfObject.fromJS(resultData200) : new MuzeyResModelOfObject();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<MuzeyResModelOfObject>(<any>null);
    }
     ...
     * @return Success
     */
    fileUpload(reqModel: MuzeyReqModelOfMuzeyUploadReqModel | null | undefined): Observable<string> {
        let url_ = this.baseUrl + "/api/services/app/Muzey/FileUpload";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processFileUpload(response: HttpResponseBase): Observable<string> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getMenuData(user: string | null | undefined): Observable<MuzeyMenuModel> {
        let url_ = this.baseUrl + "/api/services/app/Muzey/GetMenuData?";
        if (user !== undefined)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<MuzeyMenuModel>><any>_observableThrow(e);
                }
            } else
                return <Observable<MuzeyMenuModel>><any>_observableThrow(response_);
        }));
    }

    protected processGetMenuData(response: HttpResponseBase): Observable<MuzeyMenuModel> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? MuzeyMenuModel.fromJS(resultData200) : new MuzeyMenuModel();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<MuzeyMenuModel>(<any>null);
    }
}
...
export class MuzeyReqModelOfObject implements IMuzeyReqModelOfObject {
    action: string | undefined;
    totalCount: number | undefined;
    offset: number | undefined;
    pageSize: number | undefined;
    fileName: string | undefined;
    cols: MuzeyColModel[] | undefined;
    datas: any[] | undefined;

    constructor(data?: IMuzeyReqModelOfObject) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["cols"] && data["cols"].constructor === Array) {
                this.cols = [];
                for (let item of data["cols"])
                    this.cols.push(MuzeyColModel.fromJS(item));
            }
    ...
    static fromJS(data: any): MuzeyReqModelOfObject {
        data = typeof data === 'object' ? data : {};
        let result = new MuzeyReqModelOfObject();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        if (this.cols && this.cols.constructor === Array) {
            data["cols"] = [];
...
export interface IMuzeyReqModelOfObject {
    action: string | undefined;
    totalCount: number | undefined;
    offset: number | undefined;
    pageSize: number | undefined;
...
export class MuzeyColModel implements IMuzeyColModel {
    label: string | undefined;
    name: string | undefined;

    constructor(data?: IMuzeyColModel) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): MuzeyColModel {
        data = typeof data === 'object' ? data : {};
        let result = new MuzeyColModel();
        result.init(data);
        return result;
    }
...
export interface IMuzeyColModel {
    label: string | undefined;
    name: string | undefined;
}

export class MuzeyResModelOfObject implements IMuzeyResModelOfObject {
    resStatus: string | undefined;
    ...
    constructor(data?: IMuzeyResModelOfObject) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            this.offset = data["offset"];
            this.pageSize = data["pageSize"];
            if (data["bs"] && data["bs"].constructor === Array) {
                this.bs = [];
                for (let item of data["bs"])
                    this.bs.push(item);
            }
            if (data["datas"] && data["datas"].constructor === Array) {
                this.datas = [];
    ...
    static fromJS(data: any): MuzeyResModelOfObject {
        data = typeof data === 'object' ? data : {};
        let result = new MuzeyResModelOfObject();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["offset"] = this.offset;
        data["pageSize"] = this.pageSize;
        if (this.bs && this.bs.constructor === Array) {
            data["bs"] = [];
...
export interface IMuzeyResModelOfObject {
    resStatus: string | undefined;
    resMsg: string | undefined;
    totalCount: number | undefined;
    offset: number | undefined;
...
export class MuzeyReqModelOfMuzeyUploadReqModel implements IMuzeyReqModelOfMuzeyUploadReqModel {
    action: string | undefined;
    totalCount: number | undefined;
    offset: number | undefined;
    pageSize: number | undefined;
    fileName: string | undefined;
    cols: MuzeyColModel[] | undefined;
    datas: MuzeyUploadReqModel[] | undefined;

    constructor(data?: IMuzeyReqModelOfMuzeyUploadReqModel) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["datas"] && data["datas"].constructor === Array) {
                this.datas = [];
                for (let item of data["datas"])
                    this.datas.push(MuzeyUploadReqModel.fromJS(item));
            }
        }
    }

    static fromJS(data: any): MuzeyReqModelOfMuzeyUploadReqModel {
        data = typeof data === 'object' ? data : {};
        let result = new MuzeyReqModelOfMuzeyUploadReqModel();
        result.init(data);
        return result;
    }
    ...
    clone(): MuzeyReqModelOfMuzeyUploadReqModel {
        const json = this.toJSON();
        let result = new MuzeyReqModelOfMuzeyUploadReqModel();
        result.init(json);
        return result;
...
export interface IMuzeyReqModelOfMuzeyUploadReqModel {
    action: string | undefined;
    totalCount: number | undefined;
    offset: number | undefined;
    pageSize: number | undefined;
...
export class MuzeyUploadReqModel implements IMuzeyUploadReqModel {
    base64: string | undefined;
    fileName: string | undefined;

    constructor(data?: IMuzeyUploadReqModel) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): MuzeyUploadReqModel {
        data = typeof data === 'object' ? data : {};
        let result = new MuzeyUploadReqModel();
        result.init(data);
        return result;
    }
...
export interface IMuzeyUploadReqModel {
    base64: string | undefined;
    fileName: string | undefined;
}

export class MuzeyMenuModel implements IMuzeyMenuModel {
    name: string | undefined;
    permissionName: string | undefined;
    icon: string | undefined;
    route: string | undefined;
    selected: string | undefined;
    childItems: MuzeyMenuModel[] | undefined;

    constructor(data?: IMuzeyMenuModel) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["childItems"] && data["childItems"].constructor === Array) {
                this.childItems = [];
                for (let item of data["childItems"])
                    this.childItems.push(MuzeyMenuModel.fromJS(item));
            }
        }
    }

    static fromJS(data: any): MuzeyMenuModel {
        data = typeof data === 'object' ? data : {};
        let result = new MuzeyMenuModel();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        if (this.childItems && this.childItems.constructor === Array) {
            data["childItems"] = [];
            for (let item of this.childItems)
                data["childItems"].push(item.toJSON());
        }
        return data; 
    }

    clone(): MuzeyMenuModel {
        const json = this.toJSON();
        let result = new MuzeyMenuModel();
        result.init(json);
        return result;
...
export interface IMuzeyMenuModel {
    name: string | undefined;
    permissionName: string | undefined;
    icon: string | undefined;
    route: string | undefined;
...
export class GetCurrentLoginInformationsOutput implements IGetCurrentLoginInformationsOutput {
    ...
    person: BASE_PERSONDto | undefined;
    ...
    init(data?: any) {
        if (data) {
            ...
            this.person = data["person"] ? BASE_PERSONDto.fromJS(data["person"]) : <any>undefined;
        }
    }
...
export class BASE_PERSONDto implements IBASE_PERSONDto {
    id: number | undefined;
    ...
    constructor(data?: IBASE_PERSONDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): BASE_PERSONDto {
        data = typeof data === 'object' ? data : {};
        let result = new BASE_PERSONDto();
        result.init(data);
        return result;
    }
...
export interface IBASE_PERSONDto {
    id: number | undefined;
    personName: string | undefined;
    factory: string | undefined;
    workShop: string | undefined;
