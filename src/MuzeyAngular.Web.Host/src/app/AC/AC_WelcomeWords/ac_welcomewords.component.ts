...
@Component({
    templateUrl: './ac_welcomewords.component.html',
})
export class ACWelcomeWordsComponent extends AppComponentBase implements OnInit {
    @ViewChild('mtc')
    ...
    getDataPage(offset: number): void {
        ...
        serverReq.datas = [];
        serverReq.action = "ACWelcomeWords.GetDatas";
    ...
    edit(): void {
        let editDialog;
        editDialog = this._dialog.open(ACWelcomeWordsEditComponent, { data: { workShop: this.reqModel.workShop } });
        ...
        abp.message.confirm(
            ...
            (result: boolean) => {
                if (result) {
                    let serverReq = new MuzeyReqModelOfObject();
                    serverReq.datas = [];
                    serverReq.action = "ACWelcomeWords.Delete";
...
@Component({
    templateUrl: './ac_welcomewords_edit.component.html'
})
export class ACWelcomeWordsEditComponent extends AppComponentBase implements OnInit {
    ...
    constructor(
        injector: Injector,
        private _service: MuzeyServiceProxy,
        private _dialogRef: MatDialogRef<ACWelcomeWordsEditComponent>,
    ...
    ngOnInit(): void {
        let serverReq = new MuzeyReqModelOfObject();
        serverReq.datas = [];
        serverReq.action = "ACWelcomeWords.GetData";
        this.reqModel.saveData = {};
        serverReq.datas.push(this.reqModel);
        this._service.req(serverReq).subscribe(result => {
    ...
    save(): void {
        ...
        let serverReq = new MuzeyReqModelOfObject();
        serverReq.datas = [];
        serverReq.action = "ACWelcomeWords.Save";
        serverReq.datas.push(this.reqModel);
        this._service.req(serverReq)
            .pipe(
                finalize(() => {
